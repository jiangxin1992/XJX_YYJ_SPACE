...
-(void)UIConfig
{
    ...
    UILabel *label=[UILabel getLabelWithAlignment:0 WithTitle:NSLocalizedString(@"goods_detail_send_return", nil) WithFont:13.0f WithTextColor:_define_black_color WithSpacing:0];
